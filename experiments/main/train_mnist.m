...
if (ispc)
  ...
  kWorkspaceFolder = 'C:/Users/sergeyd/Workspaces/MNIST/invariance';
else
...
if (is_norm == 1) 
  ...
  train_x = train_x - repmat(train_mean, [1 1 train_num]);
  test_x = test_x - repmat(train_mean, [1 1 size(test_x, kSampleDim)]);    
end;
