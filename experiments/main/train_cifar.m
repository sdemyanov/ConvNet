...
if (ispc)
  kDatasetFolder = 'C:/Users/sergeyd/Workspaces/CIFAR/data';
  kWorkspaceFolder = 'C:/Users/sergeyd/Workspaces/CIFAR';
else
  kDatasetFolder = '/media/sergeyd/OS/Users/sergeyd/Workspaces/CIFAR/data';
  kWorkspaceFolder = '/media/sergeyd/OS/Users/sergeyd/Workspaces/CIFAR';
end;

load(fullfile(kDatasetFolder, 'cifar.mat'), 'TrainX', 'TrainY');  
load(fullfile(kDatasetFolder, 'cifar.mat'), 'TestX', 'TestY');
